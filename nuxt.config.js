...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    public: {
      ...
      siteName:
        "Construction Time-lapse & Project Management Live Cameras | Evercam",
      siteDescription:
        "Construction time-lapse cameras & project management software helps in marketing content, project management and dispute avoidance in the construction industry.",
  ...
  build: {
    transpile: ["@fortawesome/vue-fontawesome", "@googlemaps/js-api-loader"],
  },
  app: {
    head: {
      ...
      link: [
        ...
        {
          rel: "stylesheet",
          href: "https://evercam.io/wp-content/themes/evercam/css/main.css?id=2165878 ",
        },
        {
          rel: "stylesheet",
          href: "https://evercam.io/wp-content/themes/evercam/css/main.css?id=3162236",
        },
        {
          rel: "stylesheet",
          href: "https://evercam.io/wp-content/themes/evercam/fontawesome/css/all.min.css",
        },
        {
          rel: "icon",
          type: "image/x-icon",
          href: "https://evercam.io/favicon.ico",
        },
      ],
      script: [
        {
