...
<style>
    ...
    /*** RESPONSIVE END */
    .quick_form_17_css form {
        text-align: left;
    }
    .quick_form_17_css::placeholder {
        color: rgb(55, 55, 55)
    }
    .quick_form_17_css ::-webkit-input-placeholder {
        color: rgb(55, 55, 55);
    }
    .quick_form_17_css :-moz-placeholder { /* Firefox 18- */
        color: rgb(55, 55, 55);
    }
    .quick_form_17_css::-moz-placeholder { /* Firefox 19+ */
        color: rgb(55, 55, 55);
    }
    .quick_form_17_css :-ms-input-placeholder {
        color: rgb(55, 55, 55);
    }
</style>
            ...
            <div class="container">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <a class="logo" href="https://evercam.io">
                                <img src="https://evercam.io/wp-content/themes/evercam/img/white-logo.png" alt="Logo">
                            </a>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-3 slideRight order-md-4 footer-address">
                        <h3>Contact</h3>
                        <p><a href="https://goo.gl/maps/jhDWBGdppEBUpckF9" target="_blank">6-7 Granby Row, Dublin 1, Ireland</a>                            <br>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 align-self-center slideLeft">
                            <a href="https://play.google.com/store/apps/details?id=io.evercam.androidapp" target="_blank" rel="noopener"><img class=" ls-is-cached lazyloaded" src="https://evercam.io/wp-content/themes/evercam/img/google_play_download.png" data-src="https://evercam.io/wp-content/themes/evercam/img/google_play_download.png" alt="Google Paly"><span class="sr-only">Google Play</span></a>
                            <a href="https://itunes.apple.com/ie/app/evercam-play-ip-camera-viewer/id983189658?mt=8" target="_blank" rel="noopener"><img class=" ls-is-cached lazyloaded" src="https://evercam.io/wp-content/themes/evercam/img/ios-logo.png" data-src="https://evercam.io/wp-content/themes/evercam/img/ios-logo.png" alt="IOS"><span class="sr-only">Apple Store</span></a>
                        ...
                        <div class="col-md-5 align-self-center slideUp">
                            <div id="customForm">
                                ...
                                <div>
                                    <table id="SIGNUP_BODY" class="quick_form_17_css" style="background-color: #363839; color: #ffffff; border-width: 8px 1px 1px; border-image: initial; padding: 0px; margin: 0px auto; bottom: 2px; width: 100%; font-size: 11px; border-color: #363839; border-style: none; text-align: center;" border="0" cellspacing="0" cellpadding="0" align="center">
                                        <tbody>
                                        <tr>
                                            <td align="center" valign="top">
                                                <div id="SIGNUP_HEADING" style="background-color: #363839; color: #dddddd; letter-spacing: 1px; font-weight: 100; font-size: 13px; border-style: none; padding: 0px; text-align: left;">JOIN TO OUR NEWSLETTER</div>
                                                <div>
                                                    <div style="position: relative;">
                                                        <div id="Zc_SignupSuccess" style="display: none; position: absolute; margin-left: 4%; width: 90%; background-color: white; padding: 3px; border: 3px solid #c2e19a; margin-top: 10px; margin-bottom: 10px; word-break: break-all;">
                                                            <table border="0" width="100%" cellspacing="0" cellpadding="0">
                                                                <tbody>
                                                                <tr>
                                                                    <td width="10%"><img class="successicon" src="https://zcs1.maillist-manage.com/images/challangeiconenable.jpg" align="absmiddle"></td>
                                                                    <td><span id="signupSuccessMsg" style="color: #498c84; font-size: 14px; word-break: break-word;">&nbsp;&nbsp;Thank you for Signing Up</span></td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                                    </div>
                                                    <form id="zcampaignOptinForm" style="margin: 0px;" action="https://zcs1.maillist-manage.com/campaigns/weboptin.zc" method="POST" target="_zcSignup" siq_id="autopick_5124">
                                                        ...
                                                        <div><label for="CONTACT_EMAIL" class="sr-only">CONTACT EMAIL</label>
                                                            <input id="CONTACT_EMAIL" style="border-radius: 0; color: #716a6a; background-color: #ffffff;border: 1px solid #d2d2d2; padding: 4px; text-align: left; box-sizing: border-box; text-indent: 14px; outline: 0px;  border-radius: 0; font-size: 17px;height: 43px;margin-right: 5px" name="CONTACT_EMAIL" required="true" type="email" placeholder="Email">
                                                            <button id="zcWebOptin" style="background-color: #c4161c; color: #ffffff; cursor: pointer; border: none; padding: 6px 10px; outline: 0px; width: 120px; height: 43px; font-size: 13px; font-weight: bold; border-radius: 0px; text-align: center; box-shadow: none" name="SIGNUP_SUBMIT_BUTTON" onclick="	saveOptin($ZC(this).closest('form').find('#zcWebOptin'),false,function (th) {/*Before submit, if you want to trigger your event, &quot;include your code here&quot;*/
                                    });return false;">Subscribe</button>
                                                            <span id="dt_CONTACT_EMAIL" style="display: none;">1,true,6,Subscriber Email,2</span></div>
                                                        <div style="display: none; padding: 15px;"><input id="LASTNAME" style="width: 100%; color: #716a6a; background-color: #ffffff; border: 2px solid #d6cdcd; padding: 4px; text-align: left; box-sizing: border-box; text-indent: 14px; outline: 0px; border-radius: 5px; font-size: 17px; height: 43px;" name="LASTNAME" type="text" placeholder="Name"><span id="dt_LASTNAME" style="display: none;">1,false,1,Last Name,2</span></div>

                                                        <input id="fieldBorder" type="hidden" value=""><input id="submitType" name="submitType" type="hidden" value="optinCustomView"><input id="lD" name="lD" type="hidden" value="1b1aa02d41a21d3"><input id="emailReportId" name="emailReportId" type="hidden" value=""><input id="formType" name="formType" type="hidden" value="QuickForm"><input id="cmpZuid" name="zx" type="hidden" value="170d4b1"><input name="zcvers" type="hidden" value="2.0"><input id="allCheckedListIds" name="oldListIds" type="hidden" value=""><input id="mode" name="mode" type="hidden" value="OptinCreateView"><input id="zcld" name="zcld" type="hidden" value="1b1aa02d41a21d3"><input id="document_domain" type="hidden" value="zoho.com"><input id="zc_Url" type="hidden" value="zcs1.maillist-manage.com"><input id="new_optin_response_in" type="hidden" value="1"><input id="duplicate_optin_response_in" type="hidden" value="1"><input id="zc_trackCode" name="zc_trackCode" type="hidden" value="ZCFORMVIEW"><input id="zc_formIx" name="zc_formIx" type="hidden" value="0a3bda0a6b739c70eedd7fea137a80c4cbad3f9c5f6454d4">
                                ...
                                <img id="refImage" style="display: none;" src="https://zcs1.maillist-manage.com/images/spacer.gif">
                            ...
                            <div id="zcOptinSuccessPopup" style="display: none; z-index: 9999; width: 800px; height: 40%; top: 84px; position: fixed; left: 26%; background-color: #ffffff; box-shadow: 0 1px 10px #424242; padding: 35px; border: 1px solid #E6E6E6;">
                                ...
                                <span id="closeSuccess" style="position: absolute; top: -16px; right: -14px; z-index: 99999; cursor: pointer;"><img src="https://zcs1.maillist-manage.com/images/videoclose.png"></span>
