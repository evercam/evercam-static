        ...
        <div class="row">
          ...
          <div class="col-md-9" id="main-menu">
            <nav>
                <div id="navbar">
                <ul class="nav-list">
                  <li id="li-1503" class="dropdown active">
                ...
                <div class="language-dropdown">
                  ...
                  <a href="#" class="glob-icon country lang-white" id="language-dropdown">
                    <span> IE </span>
                  </a>
